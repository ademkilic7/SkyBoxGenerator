...
void EmptyLinkFunctionForGeneratedCodeSkyBoxGenerator_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_SkyBoxGenerator()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_SkyBoxGenerator_OnGetImagineHistorySuccess__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SkyBoxGenerator_GetImagineHistoryError__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SkyBoxGenerator_OnGenerateSkyboxSuccess__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SkyBoxGenerator_GenerateSkyboxError__DelegateSignature,
			};
			static const UE4CodeGen_Private::FPackageParams PackageParams = {
				"/Script/SkyBoxGenerator",
				SingletonFuncArray,
